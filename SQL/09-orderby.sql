...
SELECT * FROM students ORDER BY grade ASC, age DESC, name ASC;

-- 개수 제한
SELECT * FROM students ORDER BY grade LIMIT 5;

-- 나이가 25이상인 학생들 중에 
-- 학점이 가장 높은 사람을 나이 내림차순으로 5명만
SELECT * FROM students where age >= 25 ORDER by grade ASC, age DESC LIMIT 5;
